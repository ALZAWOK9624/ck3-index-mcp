...
func TestMCPMapToolsRegisteredAndCallable(t *testing.T) {
	...
	expectedTools := []string{
		...
		"ck3_diagnostics", "ck3_diagnostic_baseline", "ck3_refresh", "ck3_save", "ck3_script_reference", "ck3_health", "ck3_database", "ck3_package", "ck3_gui", "ck3_coat_of_arms", "map_migration_snapshot", "map_province_migration", "map_asset_audit", "map_province_mapping", "map_province_info", "map_split_province", "map_apply_split", "map_terrain_edit", "map_artifact", "map_physical_context", "map_neighbors", "map_spatial_relation", "map_strategic_passages",
