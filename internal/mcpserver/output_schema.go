...
func refreshOutputSchema() map[string]any {
	...
	success := objectSchema(map[string]any{
		...
		"source_roots": arrayProperty("Resolved source identities for private refresh operations.", objectSchema(map[string]any{
			"name":          map[string]any{"type": "string"},
			"root":          map[string]any{"type": "string"},
			"rank":          map[string]any{"type": "integer"},
			"role":          map[string]any{"type": "string"},
			"private":       map[string]any{"type": "boolean"},
			"resource_only": map[string]any{"type": "boolean"},
		}, "name", "root", "rank")),
		"last_scan_error_detail": map[string]any{"type": "string"},
